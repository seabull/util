-- $Id: alldetail_byacctstr.sql,v 1.3 2008/04/16 15:19:07 yangl Exp $
--
...
spool &lx_directory/&lx_acctstring._m1_withos.csv
        ...
        (
            ...
            select x_c.name
              from pireport.charges x_c
                    ...
                    , pireport.jnls x_j
             where 
              --      x_c.acct_id=x_ar.acct_id
              -- and 
                    x_j.jnl_id=x_c.jnl_id
               and x_c.acct_string='&lx_acctstring'
...
spool &lx_directory/&lx_acctstring._m1_withos_adjustments.csv
...
spool &lx_directory/&lx_acctstring._u1.csv
set feedback off
select
	'firstname'
	||','||'lastname'
...
spool &lx_directory/&lx_acctstring._u1_adjustments.csv
set feedback off
	--'name'
select
	'firstname'
