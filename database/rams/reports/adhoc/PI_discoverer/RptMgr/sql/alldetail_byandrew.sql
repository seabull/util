-- $Id: alldetail_byandrew.sql,v 1.1 2008/04/17 19:15:14 yangl Exp $
--
...
spool &lx_directory/&lx_andrew._m1_withos.csv
        ...
        (
            ...
            select x_c.name
             ...
             where x_c.acct_id=x_ar.acct_id
               ...
               and x_ar.emp_num=
                    (select unique emp_num from hostdb.emp_tbl where lower(andrew_uid)=lower('&lx_andrew') and rownum < 2)
...
spool &lx_directory/&lx_andrew._m1_withos_adjustments.csv
...
spool &lx_directory/&lx_andrew._u1.csv
set feedback off
select
	'firstname'
	||','||'lastname'
...
spool &lx_directory/&lx_andrew._u1_adjustments.csv
set feedback off
	--'name'
select
	'firstname'
