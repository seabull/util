-- $Header: c:\\Repository/database/rams/projects/reports_batch/ChargeChangeBatch/schema/views/view_add.sql,v 1.4 2006/07/21 16:31:40 yangl Exp $
--
...
select
        hsc.assetno
	,nvl(h.hostname,'#'||hsc.assetno) hostname
	,'Old' flag
	,hsc.pri
 ...
 where hsc.assetno=c.assetnum
   and hsc.assetno=m.assetno
   and hsc.assetno=h.assetno(+)
   and hsc.pri=h.pri(+)
/
