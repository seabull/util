-- $Header: c:\\Repository/database/rams/projects/reports_batch/AcctExpiringRpt/schema/feeder_load.spb.sql,v 1.4 2006/04/26 19:01:04 yangl Exp $

create or replace package body hostdb.feeder_load as
	...
	begin
		traceit.log(traceit.constDEBUGLEVEL_B, 'enter feeder_load.pta_load');
		...
		traceit.log(traceit.constDEBUGLEVEL_B, 'exit feeder_load.pta_load');
	end pta_load;
