...
--
  Select	/*+ Index(use) */
    ...
    ,		use.Site_Use_Id		"Site Use Id"
  --
    From	RA_Site_Uses_All	use
    ,		Ra_Addresses_All	addr
  --
    Where	use.Address_Id		= addr.Address_Id
    and		(  use.Location		like Upper('$name')
		or use.Location		like '$name'
		)
  --
    Order by	1, 2, 3, 4, 5
  ;
...
usage:
  ...
  echo "Error:  $msg"
  echo ""
  echo "Usage:  ar-loc [options] <location-pattern>"
  echo ""
  echo "Options:"
  echo ""
