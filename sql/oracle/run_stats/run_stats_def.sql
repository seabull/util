--$Id: run_stats_def.sql,v 1.2 2005/03/15 22:34:34 yangl Exp $
--
-- Utility to get execution time.
--
---------------------------------------------------------
-- pre-requisite
-- grant select on sys.v_$statname to <userid>;
-- grant select on sys.v_$mystat to <userid>;
-- grant select on sys.v_$latch to <userid>;
---------------------------------------------------------
-- e.g.
-- grant select on sys.v_$statname to hostdb;
-- grant select on sys.v_$mystat to hostdb;
-- grant select on sys.v_$latch to hostdb;
