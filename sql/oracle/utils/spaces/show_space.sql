-- $Id: show_space.sql,v 1.2 2006/11/16 20:47:05 yangl Exp $
--
-- Expert One-on-One
--
...
begin
        ...
        execute immediate
            'select ts.segment_space_management
              ...
              where seg.segment_name = :p_segname
                ...
                and seg.tablespace_anem = ts.tablespace_name
            '
            --
               into l_segment_space_mgmt
            --
              using p_segment, p_partition, p_partition, p_owner;
    exception
    ...
    -- if the object is an ASSM tablespace, we must use this API call
    -- to get space information, otherwise we use the FREE_BLOCKS
