...
# PVCS info
#
# $Archive:   //cs01pvcs/pvcs/cm/Database/archives/Applications/Utilities/T38lib/t38cfgfile.pv_  $
# $Author: A645276 $
...
#@EXPORT = qw(readConfigFile updateCfgFile %gUserDb %gSystemDb %gConfigValues);

# Add the names of functions and other package variables that we want to 
# exported on request.
@EXPORT_OK = qw(readConfigFile updateCfgFile
				%gUserDb %gSystemDb %gConfigValues
				);
...
%EXPORT_TAGS = (CFGFILE_SUBS => [qw(readConfigFile updateCfgFile)],
...
$gConfigValues{SQLSourceBox} 		= "ds01adbi";
