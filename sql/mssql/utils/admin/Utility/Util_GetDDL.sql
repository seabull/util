-- USAGE: exec Util_GetDDL YourTableName
-- or exec Util_GetDDL 'bob.example' 
-- or exec Util_GetDDL '[schemaname].[tablename]' 
--############################################################################# 
-- copyright 2004-2009 by Lowell Izaguirre scripts*at*stormrage.com all rights reserved. 
-- http://www.stormrage.com/Portals/0/SSC/Util_GetDDL2005_V304.txt
...
--EXECUTE sp_ms_marksystemobject 'Util_GetDDL' 
--############################################################################# 
CREATE PROCEDURE [dbo].[Util_GetDDL] 
    @TBL VARCHAR(255) 
AS 
BEGIN 
    SET NOCOUNT ON 
